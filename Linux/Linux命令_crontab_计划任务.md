...
`0 * * * * /path/to/your/project/run_weather_getter.sh`

或每30分钟执行一次:

`*/30 * * * * /path/to/your/project/run_weather_getter.sh`

或每天早上8点执行:

`0 8 * * * /path/to/your/project/run_weather_getter.sh`
...
crontab -n	(dry run: checks the syntax, then bails out)
